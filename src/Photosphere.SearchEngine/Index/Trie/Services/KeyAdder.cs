...
using Photosphere.SearchEngine.Index.Trie.Services.Adding;
using Photosphere.SearchEngine.Index.Trie.Services.Adding.ValueObjects;
...
namespace Photosphere.SearchEngine.Index.Trie.Services
{
